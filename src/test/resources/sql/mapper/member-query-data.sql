...
('TENANT-001', 'TEN-FASTSHIP-001', 'FASTSHIP LOGISTICS', 'ACTIVE', 'Sarah Park', '91-4820318', '010-1111-2222', 'ops@fastship.com', 'LA', 'K_GLOBAL', CURRENT_TIMESTAMP, TIMESTAMP '2026-04-01 09:00:00'),
...
INSERT INTO permission(permission_id, permission_name, created_at) VALUES
('PERM-001', 'USER_READ', CURRENT_TIMESTAMP),
('PERM-002', 'USER_WRITE', CURRENT_TIMESTAMP),
('PERM-003', 'WORK_READ', CURRENT_TIMESTAMP);
INSERT INTO role_permission(role_id, permission_id, is_enabled, can_read, can_write, can_delete, created_at) VALUES
('ROLE-002', 'PERM-001', 1, 1, 1, 0, CURRENT_TIMESTAMP),
('ROLE-002', 'PERM-002', 1, 1, 1, 0, CURRENT_TIMESTAMP),
('ROLE-003', 'PERM-003', 1, 1, 0, 0, CURRENT_TIMESTAMP);
INSERT INTO role_permission_history(history_id, role_id, permission_id, action_type, changed_by, changed_at) VALUES
('HIS-001', 'ROLE-002', 'PERM-001', 'UPDATE', 'master@conk.com', TIMESTAMP '2026-04-03 14:00:00'),
('HIS-002', 'ROLE-002', 'PERM-002', 'CREATE', 'master@conk.com', TIMESTAMP '2026-04-03 13:50:00'),
('HIS-003', 'ROLE-003', 'PERM-003', 'UPDATE', 'master@conk.com', TIMESTAMP '2026-04-03 13:40:00');
