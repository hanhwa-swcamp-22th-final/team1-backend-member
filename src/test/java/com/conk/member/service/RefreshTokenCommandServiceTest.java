...
class RefreshTokenCommandServiceTest {
    ...
    @InjectMocks RefreshTokenCommandService refreshTokenCommandService;
    ...
    void refreshToken_validToken_success() {
        ...
        LoginResponse response = refreshTokenCommandService.refreshToken("valid-refresh-token");
    ...
    void refreshToken_mismatchToken_throwsException() {
        ...
        assertThatThrownBy(() -> refreshTokenCommandService.refreshToken("valid-refresh-token"))
