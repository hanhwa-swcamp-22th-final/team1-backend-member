...
class CreateDirectUserCommandServiceTest {
    ...
    @InjectMocks CreateDirectUserCommandService createDirectUserCommandService;
    ...
    void createDirect_success() {
        ...
        CreateDirectUserResponse response = createDirectUserCommandService.createDirect(request);
    ...
    void createDirect_duplicateWorkerCode_throwsException() {
        ...
        assertThatThrownBy(() -> createDirectUserCommandService.createDirect(request))
