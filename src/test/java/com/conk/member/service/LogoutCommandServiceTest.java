...
class LogoutCommandServiceTest {
    ...
    @InjectMocks LogoutCommandService logoutCommandService;
    ...
    void logout_success() {
        ...
        logoutCommandService.logout(REFRESH_TOKEN);
    ...
    void logout_invalidToken_throwsException() {
        ...
        assertThatThrownBy(() -> logoutCommandService.logout(REFRESH_TOKEN))
    ...
    void logout_tokenMismatch_throwsException() {
        ...
        assertThatThrownBy(() -> logoutCommandService.logout(differentToken))
                .isInstanceOf(BadCredentialsException.class)
