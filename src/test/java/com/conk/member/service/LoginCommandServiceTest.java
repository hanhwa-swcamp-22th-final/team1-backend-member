...
class LoginCommandServiceTest {
    ...
    @InjectMocks LoginCommandService loginCommandService;
    ...
    void login_withEmail_success() {
        ...
        LoginResponse response = loginCommandService.login(request);
    ...
    void login_accountNotFound_throwsException() {
        ...
        assertThatThrownBy(() -> loginCommandService.login(request))
