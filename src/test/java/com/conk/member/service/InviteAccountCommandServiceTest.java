...
class InviteAccountCommandServiceTest {
    ...
    @InjectMocks InviteAccountCommandService inviteAccountCommandService;
    ...
    void invite_warehouseManager_success() {
        ...
        InviteAccountResponse response = inviteAccountCommandService.invite(warehouseManagerRequest, "ACC-INVITER");
    ...
    void invite_seller_success() {
        ...
        InviteAccountResponse response = inviteAccountCommandService.invite(sellerRequest, "ACC-INVITER");
    ...
    void invite_noInviterId_throwsException() {
        assertThatThrownBy(() -> inviteAccountCommandService.invite(warehouseManagerRequest, null))
    ...
    void invite_workerRole_throwsException() {
        ...
        assertThatThrownBy(() -> inviteAccountCommandService.invite(warehouseManagerRequest, "ACC-INVITER"))
                .isInstanceOf(MemberException.class)
    ...
    void invite_invalidSeller_throwsException() {
        ...
        assertThatThrownBy(() -> inviteAccountCommandService.invite(sellerRequest, "ACC-INVITER"))
                .isInstanceOf(MemberException.class)
                .satisfies(e -> assertThat(((MemberException) e).getErrorCode()).isEqualTo(ErrorCode.INVALID_REFERENCE));
    }
