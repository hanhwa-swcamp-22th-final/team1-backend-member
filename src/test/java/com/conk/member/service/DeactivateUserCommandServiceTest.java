...
class DeactivateUserCommandServiceTest {
    ...
    @InjectMocks DeactivateUserCommandService deactivateUserCommandService;
    ...
    void deactivate_regularUser_success() {
        ...
        SimpleUserStatusResponse response = deactivateUserCommandService.deactivate("ACC-001");
    ...
    void deactivate_lastActiveMasterAdmin_throwsException() {
        ...
        assertThatThrownBy(() -> deactivateUserCommandService.deactivate("ACC-001"))
    ...
    void deactivate_userNotFound_throwsException() {
        ...
        assertThatThrownBy(() -> deactivateUserCommandService.deactivate("ACC-999"))
                .isInstanceOf(MemberException.class)
