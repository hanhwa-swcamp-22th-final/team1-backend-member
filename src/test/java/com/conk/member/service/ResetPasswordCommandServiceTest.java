...
class ResetPasswordCommandServiceTest {
    ...
    @InjectMocks ResetPasswordCommandService resetPasswordCommandService;
    ...
    void resetPassword_success_sendsMail() {
        ...
        SimpleUserStatusResponse response = resetPasswordCommandService.resetPassword("ACC-001");
    ...
    void resetPassword_userNotFound_throwsException() {
        ...
        assertThatThrownBy(() -> resetPasswordCommandService.resetPassword("ACC-999"))
