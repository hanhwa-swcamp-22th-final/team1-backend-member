...
public class AuthTokenService {
    ...
    public MemberResponses.LoginResponse refreshToken(String providedRefreshToken) {
        ...
        String roleName = jwtTokenProvider.getRoleFromJWT(providedRefreshToken);
        ...
        String newAccessToken = jwtTokenProvider.createToken(accountId, roleName);
        String newRefreshToken = jwtTokenProvider.createRefreshToken(accountId, roleName);
